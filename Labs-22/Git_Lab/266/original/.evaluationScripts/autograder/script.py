...
my_tar.extractall("/home/labDirectory/working_directory/") # specify which folder to extract to
my_tar.close()
os.system('clear')

try:
	repo = git.Repo("/home/labDirectory/working_directory/big_repo/")
except:
	...
	os.system("rm -rf /home/labDirectory/working_directory/big_repo/")      
	exit()
