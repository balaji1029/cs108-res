...
my_tar = tarfile.open('../../labDirectory/big_repo.tar.gz')
my_tar.extractall("../../labDirectory/working_directory/") # specify which folder to extract to
my_tar.close()
os.system('clear')

try:
	repo = git.Repo("../../labDirectory/working_directory/big_repo/")
except:
	...
	os.system("rm -rf ../../labDirectory/working_directory/big_repo/")      
	exit()
