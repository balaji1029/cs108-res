...
my_tar = tarfile.open('../../labDirectory/merge_repo.tar.gz')
my_tar.extractall("../../labDirectory/") # specify which folder to extract to
my_tar.close()
os.system('clear')

try:
	repo = git.Repo("../../labDirectory/merge_repo/")
except:
	...
	os.system("rm -rf ../../labDirectory/merge_repo/")      
	exit()
...
os.system("rm -rf ../../labDirectory/merge_repo/ 2>/dev/null")
